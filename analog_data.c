...
void initAnalogValueData(void)
{
    ...
    addValue(&analogValues[0],  ANALOG_VALUE_INT,   "__SL_G_UCA", "",   (void *) &adcValues->adcCount );
    addValue(&analogValues[1],  ANALOG_VALUE_INT,   "__SL_G_UCT", "",   (void *) &adcValues->tempCount );
    ...
    addValue(&analogValues[4],  ANALOG_VALUE_FLOAT, "__SL_G_UCA", " A", (void *) &adcValues->auxmotorCurrent );
    ...
    addValue(&analogValues[7],  ANALOG_VALUE_INT,   "__SL_G_UCI", "",   (void *) &i2cValues->i2cCount );
